...
def welcome():
  ...
  printf(Center.XCenter(Colorate.Vertical(Colors.blue_to_green, f'''
                      ...
                      {random.choice(wms)}
                     WELCOME TO KATOKI C2     
           ╩══╦═════════════════════════════════╦══╩
    ╔═════════╩═════════════════════════════════╩═════════╗
                      VUI LÒNG LỰA CHỌN
        - help                 |         Xem cách sử dụng
        - tool                 |         Xem công cụ
        - credit               |         Thông tin 
  
                      ©Trần Gia Hưng X KaToKiC2
    ...
    if 'credit' in cmdl:
      ...
      printf(Center.XCenter(Colorate.Vertical(Colors.green_to_blue, f'''
        ...
        {random.choice(wms)}
             ...
             ╩══╦═════════════════════════════════╦══╩
      ╔═════════╩═════════════════════════════════╩═════════╗
         - Bản quyền: Trần Gia Hưng X KaToKi C2
         - ZALO                 : 0334063029
...
╚═╝░░╚═╝ ╚═╝░░╚═     ╚═╝     ╚════╝     
              ...
              NHẬP LỆNH :
              git clone https://github.com/hungdeptrai1702/katokiC2

              cd katokiC2

              java katokiC2
         
         lưu ý : nếu bạn nhập sai 1 bước thì bán máy tính 
         mà mua mới vì botnet sẽ làm die máy tính của bạn 

         inbox zalo hỗ trợ: 0796999769 (Trần Gia Hưng)
      ╠═════════╦═════════════════════════════════╦═════════╣
             ╦══╩═════════════════════════════════╩══╦
      '''), True), end='')
    elif 'tool' in cmdl:
